...
import st350_green_back from '$lib/assets/redmond/img/boys/fall2023/st350_green_back.png';
...
import st350_white_back from '$lib/assets/redmond/img/boys/fall2023/st350_white_back.png';
...
export const title = 'Redmond Boys Fall 2024 Tennis Apparel';
export const schoolName = 'Redmond High School';
export const collectionName = 'redmond-boysFall2024';
...
export const closeDate = new Date(2024, 7, 29, 23, 59, 59);
